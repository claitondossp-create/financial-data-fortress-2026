# === FIX: Proteger DATE contra BLANK quando nao ha filtro ===
...
VAR _diffPP = IF(ISBLANK(_anterior), BLANK(), (_atual - _anterior) * 100)
...
$srv.Disconnect()
Write-Host "`nMedidas corrigidas com protecao ISBLANK!" -ForegroundColor Green
